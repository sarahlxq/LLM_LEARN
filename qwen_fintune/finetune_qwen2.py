...
def train():
    ...
    def write_res(status, error_log):
        res = {"status": status, "path": training_args.output_dir, "log": error_log}
        save_path = os.path.join(training_args.output_dir, str(model_args.task_id) + ".json")
